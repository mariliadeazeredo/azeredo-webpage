...
import { CONTACT_INFO, NAV_ITEMS, LAWYER_NAME } from '../constants';
              ...
              <ul className="space-y-4 text-sm text-gray-400 w-full text-left">
                ...
                <li className="flex flex-col gap-1">
                  ...
                  <div className="flex flex-col">
                      ...
                      <a href={`https://wa.me/${CONTACT_INFO.whatsapp.replace(/\D/g, '')}`} className="hover:text-brand-gold transition-colors">{CONTACT_INFO.whatsapp}</a>
                  </div>
                </li>
