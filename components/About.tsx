...
export const About: React.FC = () => {
  return (
    <section id="about" className="py-20 bg-gray-50 text-brand-blue">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 bg-white rounded-lg p-8 md:p-12 shadow-sm border border-gray-100">
          ...
          <div className="w-full lg:w-1/3 relative flex justify-center lg:justify-start">
            <div className="relative">
                ...
                {/* 
                   PLACEHOLDER: Substitua o src abaixo pelo caminho da sua foto. 
                   Exemplo: src="/foto-joao-gustavo.jpg" se estiver na pasta public
                   ou importe se estiver em src/assets
                */}
                <img 
                src="https://images.unsplash.com/photo-1556157382-97eda2d62296?auto=format&fit=crop&q=80&w=600" 
                alt="Advogado em escritório" 
                className="relative w-full max-w-xs h-auto rounded-sm shadow-lg grayscale"
                />
            </div>
          </div>
