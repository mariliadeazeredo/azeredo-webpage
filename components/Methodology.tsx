...
export const Methodology: React.FC = () => {
  return (
    <section id="methodology" className="py-20 bg-brand-blue text-white relative overflow-hidden">
       {/* Decorative BG */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mt-16">
          <a 
            href={`https://wa.me/${CONTACT_INFO.whatsapp.replace(/\D/g, '')}?text=Olá, quero iniciar o atendimento.`}
            target="_blank"
